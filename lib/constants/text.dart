...
const String tRole = "Role(Student/Teacher/Recruiter)";
...
const String tForgetPasswordTitle = "Choose Method!";
...
// -- Forget Password OTP Screen - Text
const tOtpTitle = "OTP Verification";
const tOtpMessage = "Enter the OTP sent to your registered Phone No";
const tOtpSubTitle = "OTP sent";
